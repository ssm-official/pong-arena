...
function shopAnimClass(anim) {
  const map = { glow: 'shop-anim-glow', float: 'shop-anim-float', pulse: 'shop-anim-pulse', shimmer: 'shop-anim-shimmer', fire: 'shop-anim-fire', spin: 'shop-anim-spin', bounce: 'shop-anim-bounce', rainbow: 'shop-anim-rainbow', shake: 'shop-anim-shake', zoom: 'shop-anim-zoom', orbit: 'shop-anim-orbit' };
  return map[anim] || '';
}
